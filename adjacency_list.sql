...
--
-- Host: localhost    Database: adjacency2
-- ------------------------------------------------------
...
CREATE TABLE `structure` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_structure_1_idx` (`parent_id`),
  CONSTRAINT `fk_structure_1` FOREIGN KEY (`parent_id`) REFERENCES `structure` (`id`)
...
INSERT INTO `structure` VALUES (1,'КОМПАНИЯ',NULL),(2,'Департамент продаж',1),(3,'Департамент реализации проектов',1),(4,'Команда \"ONE\"',3),(5,'Гуппа разработки \"ONE\"',4),(6,'Группа тестирования \"ONE\"',4),(7,'Команда \"TWO\"',3),(8,'Гуппа разработки \"TWO\"',7),(9,'Группа тестирования \"TWO\"',7),(10,'Команда \"THREE\"',3),(11,'Гуппа разработки \"THREE\"',10),(12,'Группа тестирования \"THREE\"',10),(13,'Департамент системной интеграции',1),(14,'Команда Мониторинга',13),(15,'Команда Эксплуатации',13);
...
-- Dump completed on 2020-02-13 11:41:58
