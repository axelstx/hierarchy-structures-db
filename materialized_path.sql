...
--
-- Host: localhost    Database: materialized2
-- ------------------------------------------------------
...
INSERT INTO `structure` VALUES (1,'КОМПАНИЯ','1'),(2,'Департамент продаж','1.1'),(3,'Департамент реализации проектов','1.2'),(4,'Команда \"ONE\"','1.2.1'),(5,'Гуппа разработки \"ONE\"','1.2.1.1'),(6,'Группа тестирования \"ONE\"','1.2.1.2'),(7,'Команда \"TWO\"','1.2.2'),(8,'Гуппа разработки \"TWO\"','1.2.2.1'),(9,'Группа тестирования \"TWO\"','1.2.2.2'),(10,'Команда \"THREE\"','1.2.3'),(11,'Гуппа разработки \"THREE\"','1.2.3.1'),(12,'Группа тестирования \"THREE\"','1.2.3.2'),(13,'Департамент системной интеграции','1.3'),(14,'Команда Мониторинга','1.3.1'),(15,'Команда Эксплуатации','1.3.2');
...
-- Dump completed on 2020-02-13 11:05:19
